...
def modify_franka_panda_urdf_grasped_object(robot_file, grasped_object):
...
def modify_franka_panda_urdf_collision_model(robot_file):
...
class DifferentiableFrankaPanda(DifferentiableTree):
    def __init__(self, link_list: Optional[str] = None, gripper=False, device='cpu', grasped_object=None,
        ...
        if use_collision_spheres:
            robot_file, link_collision_names, link_collision_margins = modify_franka_panda_urdf_collision_model(robot_file)
        ...
        if grasped_object is not None:
            robot_file = modify_franka_panda_urdf_grasped_object(robot_file, grasped_object)
